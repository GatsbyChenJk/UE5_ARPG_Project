...
void UInventoryLeafLabelValue::SetText_Label(const FText& Text, bool bCollapse) const
{
	if (bCollapse)
	{
...
void UInventoryLeafLabelValue::SetText_Value(const FText& Text, bool bCollapse) const
{
	if (bCollapse)
	{
...
void UInventoryLeafLabelValue::NativePreConstruct()
{
